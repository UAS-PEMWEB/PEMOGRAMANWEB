                    ...
                    @foreach ($bidangdppkb as $gallery)
                        <div class="col-xl-3 col-md-6">
                            <div class="service-widget servicecontent">
                                ...
                                <div class="modal fade" data-backdrop="static" id="galleryModal{{$gallery->id}}" style="z-index:500000 !important" tabindex="-1" role="dialog" aria-labelledby="galleryModalLabel{{$gallery->id}}" aria-hidden="true">
