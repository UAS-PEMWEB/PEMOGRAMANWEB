    ...
    <div class="page-wrapper page-settings">
        <div class="content">
            ...
            <div class="row mb-4 justify-content-between align-items-center">
                <div class="col-auto">
                    <h5>Babuka Product Approved</h5>
                </div>
                <div class="col-auto d-flex gap-4">
                    <div class="page-headers">
                        <form action="/admin/babukaproducts/approved" method="get">
                            @csrf
                                ...
                                @foreach ($data as $item)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-outline-warning unapproveButton" data-id="{{ $item->id }}">Unapprove</button>
                                        </td>
                                    </tr>
