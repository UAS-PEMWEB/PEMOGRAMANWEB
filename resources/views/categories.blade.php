        ...
        <div class="row">
            ...
            <div class="col-md-6 col-lg-4 d-flex">
                <div class="category-card flex-fill">
                    <div class="category-img">
                        <a href="{{ url('search') }}">
                            <img src="{{ URL::asset('/assets/img/services/service-06.jpg') }}" class="img-fluid" alt="">
                        </a>
                    </div>
            ...
            <div class="col-md-6 col-lg-4 d-flex">
                <div class="category-card flex-fill">
                    <div class="category-img">
                        <a href="{{ url('search') }}">
                            <img src="{{ URL::asset('/assets/img/services/service-09.jpg') }}" class="img-fluid" alt="">
                        </a>
                    </div>
                    <div class="category-info">
                        <div class="category-name">
            ...
            <div class="col-md-6 col-lg-4 d-flex">
                <div class="category-card flex-fill">
                    <div class="category-img">
                        <a href="{{ url('search') }}">
                            <img src="{{ URL::asset('/assets/img/services/service-01.jpg') }}" class="img-fluid" alt="">
                        </a>
                    </div>
                    <div class="category-info">
                        <div class="category-name">
            ...
            <div class="col-md-6 col-lg-4 d-flex">
                <div class="category-card flex-fill">
                    <div class="category-img">
                        <a href="{{ url('search') }}">
                            <img src="{{ URL::asset('/assets/img/services/service-10.jpg') }}" class="img-fluid" alt="">
                        </a>
                    </div>
                    <div class="category-info">
                        <div class="category-name">
            ...
            <div class="col-md-6 col-lg-4 d-flex">
                <div class="category-card flex-fill">
                    <div class="category-img">
                        <a href="{{ url('search') }}">
                            <img src="{{ URL::asset('/assets/img/services/service-15.jpg') }}" class="img-fluid" alt="">
                        </a>
                    </div>
                    <div class="category-info">
                        <div class="category-name">
            ...
            <div class="col-md-6 col-lg-4 d-flex">
                <div class="category-card flex-fill">
                    <div class="category-img">
                        <a href="{{ url('search') }}">
                            <img src="{{ URL::asset('/assets/img/services/service-08.jpg') }}" class="img-fluid" alt="">
                        </a>
                    </div>
                    <div class="category-info">
                        <div class="category-name">
            ...
            <div class="col-md-6 col-lg-4 d-flex">
                <div class="category-card flex-fill">
                    <div class="category-img">
                        <a href="{{ url('search') }}">
                            <img src="{{ URL::asset('/assets/img/services/service-03.jpg') }}" class="img-fluid" alt="">
                        </a>
                    </div>
                    <div class="category-info">
                        <div class="category-name">
            ...
            <div class="col-md-6 col-lg-4 d-flex">
                <div class="category-card flex-fill">
                    <div class="category-img">
                        <a href="{{ url('search') }}">
                            <img src="{{ URL::asset('/assets/img/services/service-16.jpg') }}" class="img-fluid" alt="">
                        </a>
                    </div>
                    <div class="category-info">
                        <div class="category-name">
